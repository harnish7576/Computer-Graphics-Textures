...
function setUpTextures(){
    ...
    // leatherTexture = gl.createTexture();
    // const leatherImage = document.getElementById("-texture");;
    // leatherImage.src = 'leather2.jpg';
    // leatherImage.onload = () => {
    //     doLoad (leatherTexture,leatherImage);
    // };
...
function drawCurrentShape () {
  ...
  // if(curTexture = "myimage")
    ...
    gl.uniform1i(program.scene,2);
  //   // gl.activeTexture (gl.TEXTURE0);
  //   // gl.bindTexture (gl.TEXTURE_2D, procTexture);
  //   // gl.uniform1i (program2.uTheTexture, 0);
  }
...
function initProgram (vertexid, fragmentid) {
  ...
  program.scene = gl.getUniformLocation(program, 'scene');
